...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userSubmitPassword = findViewById(R.id.changePasswordBtn);
        ...
        userSubmitPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                netThread.sendMessage("changePassword:" + userInputNewPass);
                Intent intent = new Intent();
                intent.putExtra("newUsername", userInputNewPass);
